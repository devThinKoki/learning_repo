...
# Examples
    ...
    # Example 2
        ...
        # ---
        # You've reached the end of the program. To check another habitat, please restart the watch
...
idx = int(input("Please enter the number of the habitat you would like to view: "))
